...
class RiceVariety {
  ...
  // 台南11號: Robust, dense field, large plump grains, standard golden color
  static const RiceVariety tainan11 = RiceVariety(
    ...
    visualTraits: VarietyVisualTraits(
      stemColor: Color(0xFF558B2F),       // Standard olive green
      ripeGrainColor: Color(0xFFDAA520),  // Classic golden
      grainSize: 1.1,                      // Plump
      grainRoundness: 1.6,                 // Round-ish (稉稻)
      maxStalksMultiplier: 1.2,            // Dense field (high yield)
      stalkHeightRange: 0.45,              // Uniform height
    ),
  );

  // 高雄139號 (醜美人): Slightly taller, grains look less "pretty" (more opaque/whitish tinge)
  static const RiceVariety kaohsiung139 = RiceVariety(
    ...
    visualTraits: VarietyVisualTraits(
      stemColor: Color(0xFF4E7A27),       // Slightly lighter green (east Taiwan sunlight)
      ripeGrainColor: Color(0xFFC8B560),  // Pale gold with whitish tinge (心腹白)
      grainSize: 1.0,                      // Normal
      grainRoundness: 1.5,                 // Round (稉稻)
      maxStalksMultiplier: 1.0,            // Normal density
      stalkHeightRange: 0.55,              // Taller, more variation
    ),
  );

  // 台農71號 (益全香米): Shorter, compact plant, very round small grains
  static const RiceVariety tainung71 = RiceVariety(
    ...
    visualTraits: VarietyVisualTraits(
      stemColor: Color(0xFF6A8F3F),       // Warm green
      ripeGrainColor: Color(0xFFE8C547),  // Bright warm gold
      grainSize: 0.85,                     // Smaller, compact grains (短圓)
      grainRoundness: 1.8,                 // Very round
      maxStalksMultiplier: 1.1,            // Slightly dense
      stalkHeightRange: 0.4,               // Shorter plant
    ),
  );

  // 台稉9號: Medium height, elongated elegant grains, cool-toned
  static const RiceVariety taikeng9 = RiceVariety(
    ...
    visualTraits: VarietyVisualTraits(
      stemColor: Color(0xFF3D7A2E),       // Deep cool green (北部)
      ripeGrainColor: Color(0xFFD4AF37),  // Rich amber gold
      grainSize: 1.05,                     // Slightly plump
      grainRoundness: 1.4,                 // Slightly elongated
      maxStalksMultiplier: 1.0,            // Normal density
      stalkHeightRange: 0.5,               // Medium height
    ),
  );
}
